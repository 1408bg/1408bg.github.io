...
class Game {
  ...
  constructor(root) {
    ...
    document.querySelector('body').addEventListener("keydown", (event) => {
      if (this.keyboardEventListener) {
        this.keyboardEventListener("keydown", event);
      }
    });
    document.querySelector('body').addEventListener("keyup", (event) => {
      if (this.keyboardEventListener) {
        this.keyboardEventListener("keyup", event);
      }
    });
    document.querySelector('body').addEventListener("keypress", (event) => {
      if (this.keyboardEventListener) {
        this.keyboardEventListener("keypress", event);
      }
    })
  }
  ...
  */
  setKeyboardEventListener(listener) {
...
class Clickable extends Entity {
  ...
  */
  copy() {
    return new Clickable(this.position.copy(), this.size.copy(), this.content.copy(), this.onClick);
  }
...
class Text extends Entity {
  ...
  */
  constructor(position, text, size = null, fontSize = "16px", fontWeight = "400", color = "black") {
...
class TextInput extends Entity {
  ...
  */
  ...
  render() {
    ...
    this.element = entity;
    entity.addEventListener('click', () => {this.isFocus = !this.isFocus;});
    document.querySelector('.__rnini_root__').game.setKeyboardEventListener(async (type, event) => {
